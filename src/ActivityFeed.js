...
import { thumbsUp, thumbsDown } from './public/svgs'
      ...
      <aside className="activityFeedContainer">
        ...
        <div className="commentSection--activityfeed">
          ...
          <div className="commentContainer">
            ...
            <div className="dateOfComment">2h ago</div>
            <p className="comment">There may possible be a video tomorrow Sunday Japan Time ;D Keep a lookout!</p>
            ...
            <p className="replyText">COMMENT</p>
          ...
          <div className="commentContainer">
            ...
            <p className="comment">I'll be live streaming exclusively on @OfficialDLive starting April 14th! In my first stream I'll #supportcreators by donating up to $50,000 to up to 100 streamers. Follow me on DLive to increase the total donation amount! 
              https://dlive.tv/pewdiepie﻿</p>
            <div className="viewComment">View all comments</div>
          </div>
